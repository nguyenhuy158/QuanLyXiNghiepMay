...
{
    public partial class FormChiTietPhieuNhan : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public FormChiTietPhieuNhan()
        {
            ...
            dbContext.ChiTietPhieuNhans.LoadAsync().ContinueWith(loadTask =>
            {
                ...
                gridControl1.DataSource = dbContext.ChiTietPhieuNhans.Local.ToBindingList();
        ...
        private void gridView11_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            ChiTietPhieuNhan chiTietPhieuNhan = (ChiTietPhieuNhan)gridView1.GetRow(e.RowHandle);
